...
grav_slider = Slider(screen, 975, 300, 200, 25, min=1, max = 1000, step=10)
grav_const_dis = TextBox(screen, 905, 280, 50, 50, fontSize=20)

grav_const_dis.disable()  # Act as label instead of textbox
...
while True:
    ...
    draw_text("Gravitational constant ↓ ", pg.font.SysFont("Arial", 20), (0, 0, 0), 950, 250)
    grav_const_dis.setText(grav_slider.getValue())
    frames += 1
    ...
    for i in range(len(planet_list)):
        curr_planet = pg.draw.rect(screen, planet_list[i][1], planet_list[i][0])
